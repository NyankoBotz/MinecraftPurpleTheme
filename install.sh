...
installTheme(){
    ...
    git clone https://github.com/NyankoBotz/MinecraftPurpleTheme.git
...
repair(){
    bash <(curl https://raw.githubusercontent.com/NyankoBotz/MinecraftPurpleTheme/main/repair.sh)
}
